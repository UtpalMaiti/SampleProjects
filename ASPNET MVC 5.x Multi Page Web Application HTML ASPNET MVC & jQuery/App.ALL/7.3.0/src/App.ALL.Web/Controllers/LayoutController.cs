...
using App.ALL.Configuration.Ui;
using App.ALL.Sessions;
using App.ALL.Web.Models;
using App.ALL.Web.Models.Layout;

namespace App.ALL.Web.Controllers
{
    public class LayoutController : ALLControllerBase
    {
