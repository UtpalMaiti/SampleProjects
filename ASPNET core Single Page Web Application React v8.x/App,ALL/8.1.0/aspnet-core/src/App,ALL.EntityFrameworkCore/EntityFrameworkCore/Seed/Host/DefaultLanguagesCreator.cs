...
namespace App,ALL.EntityFrameworkCore.Seed.Host
{
    public class DefaultLanguagesCreator
    {
        public static List<ApplicationLanguage> InitialLanguages => GetInitialLanguages();

        private readonly App,ALLDbContext _context;

        private static List<ApplicationLanguage> GetInitialLanguages()
        {
            var tenantId = App,ALLConsts.MultiTenancyEnabled ? null : (int?)MultiTenancyConsts.DefaultTenantId;
        ...
        public DefaultLanguagesCreator(App,ALLDbContext context)
        {
            _context = context;
        }
