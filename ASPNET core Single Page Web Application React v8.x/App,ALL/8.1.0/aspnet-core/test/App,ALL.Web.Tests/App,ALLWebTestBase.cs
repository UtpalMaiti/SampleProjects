...
{
    public abstract class App,ALLWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static App,ALLWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(App,ALLWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<App,ALLDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<App,ALLDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<App,ALLDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<App,ALLDbContext, Task<T>> func)
        {
            T result;
